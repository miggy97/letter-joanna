...
export default {
  ...
  methods: {
    moveLetter() {
      ...
      this.$refs.letter.style.cssText =
        "margin: 0; top: 5em; right: 0; bottom: 0; left: 3em; font-size: 0.8em; transition-delay: 2.5s;";
...
.bubble-lottie {
  ...
  bottom: 0;
  left: 0;
  margin: calc(50vh - 9em) calc(50vw - 9em);
}
.letter {
  font-size: 1.2em;
  width: 8em;
  ...
  bottom: 0;
  left: 0;
  margin: calc(50vh - 2em) calc(50vw - 4em);
